...
type (
	...
	Schema interface {
		...
		Update(ctx context.Context, ID entity.SchemaID, changes entity.Schema) error
	...
	Repository interface {
		...
		UpdateSchema(ctx context.Context, ID entity.SchemaID, changes entity.Schema) error
		...
		UpdateProvider(ctx context.Context, ID entity.ProviderID, changes entity.Provider) error
