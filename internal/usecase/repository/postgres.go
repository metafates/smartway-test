...
func (p *PostgresRepository) GetAccountByID(ctx context.Context, ID string) (entity.Account, bool, error) {
	//TODO implement me
	panic("implement me")
}
...
func (p *PostgresRepository) DeleteAccount(ctx context.Context, ID string) error {
	//TODO implement me
	panic("implement me")
}
...
func (p *PostgresRepository) UpdateSchema(ctx context.Context, ID string, changes entity.Schema) error {
	//TODO implement me
	panic("implement me")
}

func (p *PostgresRepository) GetSchemaByID(ctx context.Context, ID string) (entity.Schema, bool, error) {
	//TODO implement me
	panic("implement me")
}
...
func (p *PostgresRepository) DeleteSchema(ctx context.Context, ID string) error {
	//TODO implement me
	panic("implement me")
}
...
func (p *PostgresRepository) UpdateProvider(ctx context.Context, ID string, changes entity.Provider) error {
	//TODO implement me
	panic("implement me")
}

func (p *PostgresRepository) GetProviderByID(ctx context.Context, ID string) (entity.Provider, bool, error) {
	//TODO implement me
	panic("implement me")
}

func (p *PostgresRepository) GetProvidersByIDs(ctx context.Context, IDs ...string) ([]entity.Provider, error) {
	//TODO implement me
	panic("implement me")
}

func (p *PostgresRepository) DeleteProvider(ctx context.Context, ID string) error {
	//TODO implement me
	panic("implement me")
}
